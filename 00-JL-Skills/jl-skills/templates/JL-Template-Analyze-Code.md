...
## 2. 系统调用拓扑 (System Topology)

> *描述该模块在系统级别的上下游依赖关系，涉及哪些内部微服务、外部中间件和第三方 API。非常有利于后续监控告警的配置。*

**(建议插入 mermaid 或 C4 图表示上下游关系)**

---

## 3. 业务流程设计 (Process Flow)
...
## 4. 详细业务规则 (Business Rules)

> *这是开发最容易遗漏、业务最关心的部分。请列出所有"如果...那么..."的逻辑。*

### 4.1 前置校验规则 (Validation)
...
## 5. 数据与接口设计 (Technical Perspective)

### 5.1 数据模型影响 (Schema Change)
